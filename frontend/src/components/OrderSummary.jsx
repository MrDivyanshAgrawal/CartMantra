...
const stripePromise = loadStripe(
	"pk_test_51S6acTELX7EgUQu06vmtEDFSrXxDIoqNu5efNymlGIvPSz8JisMVU1euo947lABJNNsjAK908mz9ZAFarjDTZThN00IV9Ew8WN"
);
	...
	return (
		...
		>
			...
			<div className='space-y-4'>
				...
				<motion.button
					className='btn-primary w-full flex items-center justify-center px-5 py-2.5 text-sm font-medium'
